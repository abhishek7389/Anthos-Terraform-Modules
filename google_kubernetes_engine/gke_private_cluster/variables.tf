...
variable "gcp_filestore_csi_driver_config" {
  type        = bool
  description = "Enable the filestore CSI driver addon"
  default     = true
}

variable "config_connector_config" {
  type        = bool
  description = "Enable the config connector addon for multi cluster anthos setup"
  default     = true
}

variable "application_secrets_kms_key_self_link" {
  type        = string
  description = "KMS key path variable"
  default     = ""
}
...
#  type        = string
#  description = "It defines the release channel of the control plane."
#  default     = "REGULAR"
#}
